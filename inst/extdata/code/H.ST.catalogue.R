function ()
# Function:           H.ST.catalogue
# Description:        Help function on structure of the model - details of the catalogue and codes
...
#           C.DI                                    Functions for determining diary of periods in the year
#           C.DI.Diary.01.01          #  ID = 11004  Generating the diary of events for the year
#           C.DI.Diary.01.output.01   #  ID = 11012 Output diary to file
