...
# Function:           B.FO.Predation.01.01
# Description:        Predation in a time step Function 1
...
#      Signature <- list(
#        ID           =  29005,
#        Name.full    = "Predation function 01",
#        Name.short   = "Predation01",
#        Version      = "01",
#        Authors      = "A.Constable",
...
PreyAbundUnit <- dSet$Prey.data[[prey]]$FnFeedParams$AbundUnit
...
#             get abundance (based on AbundUnit) of prey and use functional feeding relationship to determine consumption
...
#             in this case, no stage structure is used - therefore StageStructure is as it was before
                ...
                pData<-dSet$Prey.data[[prey]]$FnFeedParams
                 PreyConsumed<-dSet$Prey.data[[prey]]$FnFeedParams$Scale.vector[[pnPred]][pnPrey,2]* #scale vector
                         dSet$Prey.data[[prey]]$FnFeed(pData[[1]][pnPred],
                         c(pData[[2]][[pnPred]][is.element(pData[[2]][[pnPred]][,1],pnPrey),2]),c(PreyAbund))
