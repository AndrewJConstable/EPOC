...
# Function:           B.G_.pred_unknown.01.setup.01
# Description:        Unknown predator - setup function
...
#      ID           = 28002,
#      Name.full    = "Unknown predator Type I - setup",
#      Name.short   = "Type I pred setup",
#      Morph        = "01",
#      Version      = "01",
#      Authors      = "A.Constable",
...
# alter annual rates of consumption etc. to match the rate in a timestep - in this case constant mortality rate is desired
...
#                determine migration pattern for the period, taking account of the proportion of the year of the period
                 ...
                 PtSA$dSet$Pattern<-(1-(1-Taxon$TimeSteps[[Tstep.current]]$actions$migrate$dSet$Pattern)^Diary[[pe]]$YearPropn)
...
#    number of actions (set to 0 until actions added), list of actions (set to null until actions added)
     ...
     if(PtStepAction.N>0) {
        ...
        PtimeSteps[[pe]]$actions.N<-PtStepAction.N
