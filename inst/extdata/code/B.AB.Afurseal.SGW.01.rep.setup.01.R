...
# Function:           B.AB.Afurseal.SGW.01.rep.setup.01
# Description:        Biological Element, Group Air-breathers, Antarctic Fur Seal - South Georgia - reproductives - setup function
...
#      ID           = 25008,
#      Name.full    = "Ant fur seal SGW Reproductive adult setup",
#      Name.short   = "AFS SGW RA",
#      Morph        = "01",
#      Version      = "01",
#      Authors      = "A.Constable",
